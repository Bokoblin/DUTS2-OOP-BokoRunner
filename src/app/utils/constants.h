...
static const std::string DEFAULT_CONFIG_CONTENT = "<?xml version=\"1.0\"?>\n"
        ...
        "\t\t<configItem type=\"boolean\" name=\"game_music\" value=\"false\"/>\n"
        "\t</config>\n"
        "\t<stats>\n"
        ...
        "\t\t<shopItem type=\"boolean\" id=\"shop_shieldPlus\" price=\"100\" bought=\"false\"/>\n"
        "\t\t<shopItem type=\"boolean\" id=\"shop_megaPlus\" price=\"200\" bought=\"false\"/>\n"
        "\t\t<shopItem type=\"boolean\" id=\"shop_flyPlus\" price=\"180\" bought=\"false\"/>\n"
