...
*********************************************/
MenuView::MenuView(float w, float h, sf::RenderWindow *window, Text * text): View(w, h, window,text)
{
...
/********************************************
    Destructor
*********************************************
    @author Arthur  @date 26/02 - 14/04
*********************************************/
MenuView::~MenuView()
{
